...
import uk.gov.hmcts.challenge.task_manager.repository.TaskRespostory;

@Getter
public class DatabaseTestUtil {

    private final TaskRespostory taskRepository;
    private List<Task> taskList = new ArrayList<>();

    public DatabaseTestUtil(final TaskRespostory taskRepository) {
